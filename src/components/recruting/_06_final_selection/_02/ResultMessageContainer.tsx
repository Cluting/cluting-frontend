    ...
    <form onSubmit={onSubmit} className="w-full">
      ...
      <div className="relative">
        <div className="bg-gray-50 border border-gray-200 rounded-t-[6.65px]">
          ...
          <div className="relative bg-white-100 h-[520px] rounded-b-[6.65px]">
            {isVisible && (
              <img
                onClick={() => {
                  setIsVisible(false);
                }}
                src="/assets/messageExample-6-2.jpg"
                className="absolute w-[560px] top-[20px] left-[25px]"
              />
            )}

            <textarea
              {...register(messageType, { required: "필수 작성 내용입니다." })}
              placeholder="최종 합격 및 면접 안내에 대한 메시지를 작성해 주세요."
