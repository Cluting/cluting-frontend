    ...
    <li className="flex items-center p-4 h-16 border-b-[0.5px] border-[#D6D7DA] gap-2">
      ...
      <div className="w-32 text-sm font-medium text-left font-Pretendard">
        <button
          ...
          className="flex w-20 h-8 ml-auto text-xs font-medium border rounded-lg flex-center bg-main-300 border-main-400 font-Pretendard text-[#5E2BE8] hover:button-main-bg"
        >
          질문 만들기
        </button>
      </div>
