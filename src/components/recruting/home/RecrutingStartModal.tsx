...
export default function RecrutingStartModal() {
  ...
  return (
    <div className="m-[30px] flex flex-col bg-white-100 w-[545px] h-[430px] rounded-[12px]">
      <h1 className="text-title3 mt-[28px] mb-[19px]">
        '잇타' 리크루팅 시작하기
      </h1>
      <hr className="w-full py- border border-gray-200 " />

      <form className="flex flex-col items-center mt-[35px]">
        <p className="text-callout">
          <span className="text-main-100 mr-[5px]">*</span>기수를 입력해 주세요.
        </p>
        <input
          type="text"
          placeholder="1기"
        ...
        <p className="text-callout">
          <span className="text-main-100 mr-[5px]">*</span>전형을 선택해 주세요.
        </p>
