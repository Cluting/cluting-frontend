...
export default function PrepareStepRoles() {
  ...
  return (
    <div className="w-[1100px]">
      <div className="flex">
        <div className="w-full h-auto bg-white-100 custom-shadow rounded-[12px] ml-[31.38px] pt-[22px] pb-[38px] ">
          <div className="ml-[22px] mr-[39px] flex justify-between">
            <div className="flex">
              <p className="section-title">
                <span className="mr-[0.25em] text-main-100">*</span>모집 준비
                단계 역할 분담
              </p>
          ...
          <div className="pl-[47px] pr-[48px]">
            <div className="mt-8 w-full h-auto rounded-[10px] bg-gray-100 border border-gray-300">
              <div className="flex">
                {/* 왼쪽 열 */}
                <div className="w-[63.89px] bg-gray-200 border-r border-gray-400 rounded-l-[10px]">
                  ...
                  <div className="flex-center min-h-[329px] text-[#3B3D46] text-caption1">
                    권한자
                  </div>
                </div>

                {/* 오른쪽 컨텐츠 영역 */}
                <div className="flex w-[920px] pl-[27.35px] pt-[21px] pr-[33.77px]">
                  {/* 준비단계 컨텐츠 */}
                  {steps.map((step) => (
                    <div
                      key={step.id}
                    ...
                    >
                      <div className="w-[139px] h-[66px] bg-gray-200 rounded-[12px] flex-center text-caption1">
                        {step.name}
                      </div>
                      <div className="mt-[29px]">
                        ...
                        {!step.isFixed && (
                          <button
                            className="relative  w-[139px] h-[43px] border border-gray-200 bg-gray-100 rounded-[10px] flex-center text-[15px] font-semibold text-gray-500 hover:bg-gray-300 hover:border-gray-500 hover:text-gray-700"
                            onClick={() => {
