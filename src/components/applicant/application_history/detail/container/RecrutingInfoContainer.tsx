      ...
      <div className="w-[390px] px-[19px] py-[17px] bg-gray-50 border border-gray-200 rounded-lg">
        <div className="mb-[30px]">
          ...
          <div className="mb-[9px] w-full h-[83px] px-[92px] py-[15px] bg-gray-100 rounded-[7px]">
            <span className="mb-2 flex-center justify-between">
        ...
        <div className="mb-[30px]">
          ...
          <div className="mb-[9px] w-full h-[146px] px-[65px] py-[13px] bg-gray-100 rounded-[7px] ">
            <span className="mb-4 flex-center justify-between ">
        ...
        <div>
          ...
          <div className="mb-[9px] w-full h-[200px] bg-gray-100 rounded-[7px]"></div>
        </div>
      </div>
    </div>
  );
