...
export default function SignupContainer() {
  ...
  return (
    <div className="w-[680px] py-20 mb-40 rounded-[14px] border-[#D6D7DA] bg-white-100 flex flex-col items-center">
      <section className="flex flex-col text-left mb-10">
        ...
        <Input type="text" placeholder="거주지" />
      </section>
      ...
      <section className="flex flex-col text-left my-10">
        ...
        <Input type="text" placeholder="학교" required />
        ...
        <Input type="text" placeholder="전공" required />
        <Input type="text" placeholder="(선택) 다전공 (복수 전공, 부전공)" />
      </section>
